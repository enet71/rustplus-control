...
const rustplusPath = path.join(__dirname, '..', 'node_modules', '@liamcottle', 'rustplus.js', 'rustplus.js');
...
if (!/message AppEntityPayload \{[\s\S]*?message Item \{[\s\S]*?optional bool itemIsBlueprint = 3;/.test(patched)) {
